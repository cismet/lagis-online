...
const KassenzeichenTabelle = () => {
    const columns = [{
      ...
      const buttons = <Button><i className="fa fa-search-plus fa-lg" /></Button>;

    return  (
        <CustomTable data={extractKassenzeichen(jsonData)} columns={columns} additionalButtons={buttons}/>
    );
