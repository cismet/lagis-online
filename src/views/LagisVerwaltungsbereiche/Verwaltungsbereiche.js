...
const Verwaltungsbereiche = () => {
    return  (<div className="animated fadeIn" style={{margin: "10px"}}>
                <Row>
                  <Col xs="20" lg="7">
                      <Row>
                          <Col lg="12">
                      ...
                      <Row>
                          <Col xs="12" lg="6">
                              <Card>
                                  <CardHeader>
                                      <i className="fa fa-align-justify"></i> zusätzliche Rollen
                                  </CardHeader>
                                  <CardBody>
                          ...
                          <Col xs="12" lg="6">
                              <Card>
                                  <CardHeader>
                                      <i className="fa fa-align-justify"></i> Straßenfronten
                                  </CardHeader>
                                  <CardBody>
                              ...
                              <Card>
                                  <CardHeader>
                                    ...
                                    <CardBody>
                                        ...
                                        <Input type="textarea" name="text" id="bemerkungTa" readOnly value={jsonData.bemerkung}/>
                                    </FormGroup>
